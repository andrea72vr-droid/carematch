      ...
      <div className="w-full max-w-[400px] relative z-10 animate-slide-up">
        ...
        <div className="bg-white border border-neutral-200 p-8 rounded-2xl shadow-xl">
          ...
          <div className="relative flex items-center justify-center my-6">
            ...
            <span className="absolute px-4 text-[9px] font-bold tracking-[0.3em] text-neutral-400 uppercase bg-white">Oppure continua con</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2 py-2.5 px-4 border border-neutral-200 rounded-xl hover:bg-neutral-50 transition-all group"
            >
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider text-neutral-700">Google</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider text-neutral-700">GitHub</span>
            </button>
          </div>
